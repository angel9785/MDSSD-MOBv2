...
for id in range(0,17908):
    ...
    # print(y)
        ...
        # image.save('/home/fereshteh/kaist/augm/rgb1/'+ 'I'+ '{0:05}'.format(n)+ '.png')
        wc,hc=image.size
        # if (int(xmin)<150):
        #     xnew=wc-int(xmin)-int(w)
        #     # left=0
    ...
    # print(xmin,ymin,w,h)
        ...
        x1=root[j][1][0].text
        w=root[j][1][2].text
        xnew=wc-int(x1)-int(w)
            # y1=root[m][1][1].text
            # w1=root[m][1][2].text
            # h1=root[m][1][3].text

        root[j][1][0].text = root[j][1][0].text.replace(x1,str(xnew))
        # xr=root[j][1][0].text
        # yr=root[j][1][1].text
        # wr=root[j][1][2].text
        # hr=root[j][1][3].text
        ...
        # image.save("/home/fereshteh/kaist/"+str(n)+str(j)+".jpg", quality=95)
    ...
    image.save('/home/fereshteh/kaist/augm/lwflipt/'+ 'I'+ '{0:05}'.format(n)+ '.png')
    # tree.write('/home/fereshteh/kaist/augm/xmlflipt/'+'I'+ '{0:05}'.format(n)+ '.xml', encoding='latin-1')
    n=n+1

...
def create_data_lists(kaist_path, output_folder):
    ...
    sanitrain_rgb = '/home/fereshteh/kaist/sanitized_annotations1/sanitized'
    ...
    # for path in sani:
    sanitval_rgb =  '/home/fereshteh/kaist/sanitest'
...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, best_loss, is_best):
    ...
    filename = '513_mob2_fine_checkpoint_ssd_rgb_bn_new6.pth.tar'

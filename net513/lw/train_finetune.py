...
def main():
    ...
    config_file_path ="/home/fereshteh/code_513/lw/config.json"
    ...
    # checkpoint = None
    checkpoint = torch.load('./513mob2_fine_checkpoint_ssd_lw_bn_new6.pth.tar')
    ...
    # global model
    # checkpoint = torch.load("./513pascalvoc_dec_checkpoint_ssd_new10.pth.tar", map_location=device)

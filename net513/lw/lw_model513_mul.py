...
class LW_PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv11_feats, conv13_feats, conv14_2_feats, conv15_2_feats, conv16_2_feats):  # , conv17_2_feats,conv18_2_feats
        ...
        locs = torch.cat([l_conv11, l_conv13, l_conv14_2, l_conv15_2, l_conv16_2], dim=1)  # (N, 2268, 4) , l_conv17_2,l_conv18_2
...
class SSD_LW(nn.Module):
    ...
    def forward(self, LW_image):
        ...
        layer_output = x
        LW_features_9x9,LW_features_5x5, LW_features_3x3 = self.LW_aux_network(layer_output)  # , LW_features_2x2, LW_features_1x1
        LW_refine_33x33, LW_refine_17x17,LW_refine_9x9, LW_refine_5x5, LW_refine_3x3 = self.LW_DeConvolutions(LW_features_33x33,

...
checkpoint_rgb = torch.load('./513_mob2_fine_checkpoint_ssd_rgb3.pth.tar')
...
checkpoint_lw = torch.load('./513mob2_fine_checkpoint_ssd_lw_new1.pth.tar')
...
def main():
    ...
    checkpoint = torch.load('./dec_mob2_NEW_fine_checkpoint_ssd300_fusion9.pth.tar')
    ...
    for epoch in range(start_epoch, epochs):
        ...
        #                                                pin_memory=True)
        # if (epoch ==10):
        #     train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=7, shuffle=False,
        #                                                collate_fn=train_dataset.collate_fn, num_workers=workers,
        #                                                pin_memory=True)
        # if (epoch ==25):
        #

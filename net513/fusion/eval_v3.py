...
# checkpoint ="dec_mob2_NEW_fine_checkpoint_ssd_fusion_bn_770_3.pth.tar"
...
# checkpoint ="new_6d_mob2_NEW_fine_checkpoint_ssd300_fusion.pth (copy).tar"
...
def evaluate(test_loader, model):
    ...
    with torch.no_grad():
        ...
        APs, mAP, precision,recall,f ,n_easy_class_objects,true_positives,false_positives,lamr,ap= calculate_mAP_kaist(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties)
        h=h=1

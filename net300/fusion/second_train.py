...
checkpoint_rgb = torch.load('./new_fine_checkpoint_ssd300_rgb.pth.tar')
...
checkpoint_lw = torch.load('./new_fine_checkpoint_ssd300_lw.pth.tar')
...
def main():
    ...
    # checkpoint = None
    # checkpoint = torch.load('./NEW19_fine_checkpoint_ssd300_fusion_7.pth.tar')

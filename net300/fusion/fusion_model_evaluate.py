...
with torch.no_grad():
    ...
    for i, (images_rgb,images_lw, boxes, labels, difficulties) in enumerate(tqdm(test_loader, desc='Evaluating')):
        ...
        det_boxes1, det_labels1, det_scores1 = detect_objects1(priors_cxcy, predicted_locs_lw, predicted_locs_rgb, predicted_scores_lw, predicted_scores_rgb,predicted_scores, min_score=0.28,

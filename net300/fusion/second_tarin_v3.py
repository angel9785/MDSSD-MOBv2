...
checkpoint_rgb = torch.load('/home/fereshteh/codergb_new/6_mob2_fine_checkpoint_ssd300_rgb.pth.tar')
...
checkpoint_lw = torch.load('/home/fereshteh/codelw_new/6_mob2_fine_checkpoint_sssd3300_lw.pth.tar')
...
# checkpoint=torch.load('mob2_NEW_fine_checkpoint_ssd300_fusion4.pth (another copy).tar')
...
def main():
    ...
    # checkpoint = None
    # checkpoint = torch.load('./BEST_6_mob2_NEW_fine_checkpoint_ssd300_fusion.pth.tar')

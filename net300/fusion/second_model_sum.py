...
class SSD_FUSION(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        FUSION_features_5x5 = RGB_features_5x5+LW_features_5x5
        # FUSION_features_5x5 = self.conv5(FUSION_features_5x5)
        FUSION_features_3x3 = RGB_features_3x3+LW_features_3x3
        # FUSION_features_3x3 = self.conv3(FUSION_features_3x3)
        FUSION_features_2x2 = RGB_features_2x2+LW_features_2x2
        # FUSION_features_2x2 = self.conv2(FUSION_features_2x2)
        FUSION_features_1x1=RGB_features_1x1+LW_features_1x1

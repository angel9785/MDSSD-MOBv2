...
class BaseNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        return features_38x38,features_19x19, features_10x10
...
class FUSION_PredictionConvolutions(nn.Module):
    ...
    def forward(self,conv5_feats, conv11_feats, conv13_feats, conv14_2_feats, conv15_2_feats):
        ...
        locs = torch.cat([l_conv5,l_conv11, l_conv13, l_conv14_2, l_conv15_2], dim=1)  # (N, 2268, 4)
        classes_scores = torch.cat([c_conv5,c_conv11, c_conv13, c_conv14_2, c_conv15_2],
...
class FUSION_AuxillaryConvolutions(nn.Module):
    ...
    def forward(self, FUSION_inp_features_10x10):
        ...
        return FUSION_features_5x5, FUSION_features_3x3
...
class SSD_FUSION(nn.Module):
    def __init__(self, num_classes, backbone_network):
        ...
        # self.conv38 = nn.Conv2d(512, 256, 1, 1, 0, bias=False)
        ...
        # self.conv38 = nn.Conv2d(512, 256, 1, 1, 0)
        ...
        for layer in self.conv38.children():
            if isinstance(layer, nn.Conv2d):
                nn.init.xavier_uniform_(layer.weight)
    ...
    def forward(self, x1, x2):
        ...
        x2 = x2.to(device)
        RGB_features_38x38,RGB_features_19x19, RGB_features_10x10 = self.RGB_base_net.forward(x1)
        LW_features_38x38,LW_features_19x19, LW_features_10x10 = self.LW_base_net.forward(x2)
        ''''
        layer2=self.module2[start_layer_index]
        i=1
        for layer1 in self.module1[start_layer_index: 14]:
        ...
        RGB_features_5x5, RGB_features_3x3 = self.rgb_aux_network.forward(layer_output)
        LW_features_5x5, LW_features_3x3 = self.lw_aux_network.forward(layer_output1)
        ...
        features = []
        features.append(FUSION_features_38x38)
        ...
        FUSION_locs, FUSION_class_scores = self.FUSION_prediction_network.forward(FUSION_features_38x38,

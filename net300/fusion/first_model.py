...
class SSD_FUSION(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        for end_layer_index in source_layer_indexes:
            for layer in self.BaseNetwork.module1[start_layer_index: end_layer_index]:
                x1 = layer(x1)
            layer_output = x1
            start_layer_index = end_layer_index
            if flag == 0:
            ...
            # for end_layer_index in source_layer_indexes:
            for layer1 in self.BaseNetwork.module2[start_layer_index1: end_layer_index]:
                x2 = layer1(x2)
            layer_output1 = x2
            start_layer_index1 = end_layer_index
            if flag1 == 0:
        ...
        # FUSION_features_10x10 =tuple(map(operator.add, RGB_features_10x10, LW_features_10x10))

        # conv10 = nn.Conv2d(2048, 1024, 1, 1, 0, bias=False)
        ...
        # FUSION_features_19x19 = tuple(map(operator.add, RGB_features_19x19 , LW_features_19x19 ))
        ...
        FUSION_features_5x5, FUSION_features_3x3, FUSION_features_2x2, FUSION_features_1x1 = self.FUSION_aux_network(layer_output)

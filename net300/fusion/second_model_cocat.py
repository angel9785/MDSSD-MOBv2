...
class SSD_FUSION(nn.Module):
    def __init__(self, num_classes, backbone_network):
        ...
        self.RGB_base_net = BaseNetwork().model
        self.LW_base_net = BaseNetwork().model
        ''''
    ...
    def forward(self, x1, x2):
        ...
        RGB_features_5x5, RGB_features_3x3, RGB_features_2x2, RGB_features_1x1 = self.RGB_aux_network.forward(layer_output)
        ...
        FUSION_locs, FUSION_class_scores = self.FUSION_prediction_network.forward(FUSION_features_19x19, FUSION_features_10x10, FUSION_features_5x5, FUSION_features_3x3,
                                                             FUSION_features_2x2, FUSION_features_1x1)

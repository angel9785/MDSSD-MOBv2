...
checkpoint ="new_mob2_NEW_fine_checkpoint_ssd300_fusion9.pth.tar"

# checkpoint = 'NEW_fine_checkpoint_ssd300_fusion9.pth (3rd copy).tar'
# checkpoint ="BEST_mob2_NEW_fine_checkpoint_ssd300_fusion5.pth.tar"

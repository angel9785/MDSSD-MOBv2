...
#
#             # with open (path) as f:
#             objects1 = parse_annotation2(filename1)
...
#     # # sani=os.path.join(kaist_path, 'sanitest_txt')
#     # # for path in sani:
#     sanitest_rgb = '/home/fereshteh/kaist/eval_rgb'
#     sanitest_lw = '/home/fereshteh/kaist/eval_lw'
...
def resize(image_rgb, image_lw, boxes, dims=(300, 300), return_percent_coords=True):
    """
...
def transform(m,image_rgb, image_lw, boxes, labels, difficulties, split):
    ...
    new_image_rgb1, new_image_lw1, new_boxes = resize(new_image_rgb, new_image_lw, new_boxes, dims=(300, 300))
    # if ((new_boxes[:,0]<0).sum())>0:
    #     print("jj")
    # for i in range(0, len(new_boxes)):
    #     if (new_boxes[i, 2] == 0):
...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, best_loss, is_best):
    ...
    filename = 'newd_mob2_NEW_fine_checkpoint_ssd300_fusion.pth.tar'

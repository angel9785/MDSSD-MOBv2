...
class SSD_FUSION(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        FUSION_features_10x10 = torch.cat((RGB_features_10x10*0.8, LW_features_10x10*1.2), dim=1)
        FUSION_features_10x10 = self.conv10(FUSION_features_10x10)
        FUSION_features_19x19 = torch.cat((RGB_features_19x19*0.8, LW_features_19x19*1.2), dim=1)
        ...
        FUSION_features_5x5 = torch.cat((RGB_features_5x5*0.8, LW_features_5x5*1.2), dim=1)
        FUSION_features_5x5 = self.conv5(FUSION_features_5x5)
        FUSION_features_3x3 = torch.cat((RGB_features_3x3*0.8, LW_features_3x3*1.2), dim=1)
        FUSION_features_3x3 = self.conv3(FUSION_features_3x3)
        FUSION_features_2x2 = torch.cat((RGB_features_2x2*0.8, LW_features_2x2*1.2), dim=1)
        FUSION_features_2x2 = self.conv2(FUSION_features_2x2)
        FUSION_features_1x1 = torch.cat((RGB_features_1x1*0.8, LW_features_1x1*1.2), dim=1)

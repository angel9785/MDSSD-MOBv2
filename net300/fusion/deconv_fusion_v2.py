...
class FUSION_DeConvolutions(nn.Module):
    ...
    def forward(self,RGB_features_19x19, RGB_features_10x10, RGB_features_5x5, RGB_features_3x3, LW_features_19x19, LW_features_10x10, LW_features_5x5, LW_features_3x3):
        ...
        cat_refine_5x5 = torch.cat((RGB_features_5x5, LW_features_5x5), dim=1)
        fusion_refine_5x5 = self.conv5(cat_refine_5x5)
        # fusion_refine_5x5=RGB_features_5x5+LW_features_5x5
        x5 = fusion_refine_5x5 + FUSION_dconv_3x3+ RGB_refine1_5x5 + LW_refine1_5x5
        # x5 = torch.cat((fusion_refine_5x5 , FUSION_dconv_3x3 , RGB_refine1_5x5 , LW_refine1_5x5), dim=1)
        ...
        cat_refine_10x10 = torch.cat((RGB_features_10x10, LW_features_10x10), dim=1)
        fusion_refine_10x10 = self.conv10(cat_refine_10x10)
        # fusion_refine_10x10=RGB_features_10x10+ LW_features_10x10
        x10 = fusion_refine_10x10 + FUSION_dconv_5x5 + RGB_refine1_10x10 + LW_refine1_10x10
        # x10 = torch.cat((fusion_refine_10x10 , FUSION_dconv_5x5 , RGB_refine1_10x10 , LW_refine1_10x10), dim=1)
        ...
        cat_refine_19x19 = torch.cat((RGB_features_19x19, LW_features_19x19), dim=1)
        # fusion_refine_19x19 = RGB_features_19x19+ LW_features_19x19
        fusion_refine_19x19 = self.conv19(cat_refine_19x19)
        x19 = fusion_refine_19x19 + FUSION_dconv_10x10 + RGB_refine1_19x19 + LW_refine1_19x19
        # x19 = torch.cat((fusion_refine_19x19 , FUSION_dconv_10x10 , RGB_refine1_19x19 , LW_refine1_19x19), dim=1)

...
checkpoint_rgb = torch.load('/home/fereshteh/codergb_new/new_fine_checkpoint_ssd300_rgb.pth.tar')
...
checkpoint_lw = torch.load('/home/fereshteh/codelw_new/new_fine_checkpoint_ssd300_lw.pth.tar')
...
def main():
    ...
    # checkpoint = None
    # checkpoint = torch.load('./NEW_fine_checkpoint_ssd300_fusion2.pth (copy).tar')

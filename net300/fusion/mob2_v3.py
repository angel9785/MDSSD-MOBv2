...
from mobilenet_ssd_priors_v3mob2 import *
...
class FUSION_PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes, backbone_net):
        ...
        if backbone_net == 'MobileNetV2':
            # self.loc_conv5 = nn.Conv2d(32, n_boxes['conv5'] * 4, kernel_size=3, padding=1)
            ...
            # self.cl_conv5 = nn.Conv2d(32, n_boxes['conv5'] * n_classes, kernel_size=3, padding=1)
...
class SSD_FUSION(nn.Module):
    def __init__(self, num_classes, backbone_network):
        ...
        # self.conv38 = nn.Conv2d(64, 32, 1, 1, 0)
    ...
    def forward(self, x1, x2):
        ...
        #         if index == 18:
        #             RGB_features_10x10 = x
        # FUSION_features_38x38 = torch.cat((RGB_features_38x38, LW_features_38x38), dim=1)
        # FUSION_features_38x38 = self.conv38(FUSION_features_38x38)
        ...
        FUSION_features_5x5 = torch.cat((LW_features_5x5, RGB_features_5x5), dim=1)
        FUSION_features_5x5 = self.conv5(FUSION_features_5x5)
        FUSION_features_3x3 = torch.cat((LW_features_3x3, RGB_features_3x3), dim=1)
        FUSION_features_3x3 = self.conv3(FUSION_features_3x3)
        FUSION_features_2x2 = torch.cat((LW_features_2x2, RGB_features_2x2), dim=1)
        FUSION_features_2x2 = self.conv2(FUSION_features_2x2)
        FUSION_features_1x1 = torch.cat((LW_features_1x1, RGB_features_1x1), dim=1)
        ...
        FUSION_locs, FUSION_class_scores = self.FUSION_prediction_network.forward(
                                                                                  FUSION_features_19x19,

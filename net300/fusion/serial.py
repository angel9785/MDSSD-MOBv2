...
print(start2 - start)
# i=i+10
predicted_locs_lw, predicted_scores_lw = lw(id)
fps.update()
start4 = time.time()
print(start4-start2)
...
det_boxes, det_labels, det_scores = detect_objects(priors_cxcy, predicted_locs_lw, predicted_locs_rgb, predicted_scores_lw, predicted_scores_rgb, min_score=0.4,

...
def main():
    ...
    # Learning parameters
    # checkpoint = 'new_mob2_NEW_fine_checkpoint_ssd300_fusion8.pth.tar'#None  # path to model checkpoint, None if none
    # checkpoint = None
    # checkpoint = torch.load('./d3_mob2_NEW_fine_checkpoint_ssd300_fusion5.pth.tar')
    # checkpoint = torch.load('./BEST_new4_6d_mob2_NEW_fine_checkpoint_ssd300_fusion.pth.tar')
    ...
    with torch.no_grad():
        ...
        #     param.copy_(state_dict["LW_base_net."+param_name])
        #
        ...
        # for param_name, param in model.FUSION_DeConvolutions.named_parameters():
        #     param.copy_(state_dict["FUSION_DeConvolutions."+param_name])
        # for param_name, param in model.FUSION_prediction_network.named_parameters():
        #     if ((param_name!='loc_conv11.weight') & (param_name!='cl_conv11.weight')&(param_name!='loc_conv11.bias') & (param_name!='cl_conv11.bias')) :
        #         param.copy_(state_dict["FUSION_prediction_network." + param_name])
        # print(state_dict_RGB)
        # print(state_dict_LW)
        for param_name, param in model.RGB_base_net.named_parameters():
        ...
        # for param_name, param in model.FUSION_DeConvolutions.refine10_rgb.named_parameters():
        #     param.copy_(state_dict_RGB["RGB_DeConvolutions.refine10." + param_name])
        # for param_name, param in model.FUSION_DeConvolutions.refine19_rgb.named_parameters():
        #     param.copy_(state_dict_RGB["RGB_DeConvolutions.refine19." + param_name])
        #
        ...
        # for param_name, param in model.FUSION_DeConvolutions.refine10_lw.named_parameters():
        #     param.copy_(state_dict_LW["LW_DeConvolutions.refine10." + param_name])
        # for param_name, param in model.FUSION_DeConvolutions.refine19_lw.named_parameters():
        #     param.copy_(state_dict_LW["LW_DeConvolutions.refine19." + param_name])
    # global model
    # state_dict = checkpoint['model']
    # with torch.no_grad():
    #     for param_name, param in model.RGB_base_net.named_parameters():
    ...
    # model.load_state_dict(checkpoint_rgb['model'], strict=False)  # Optimizing parameters

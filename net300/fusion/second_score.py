...
class SSD_FUSION(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        FUSION_features_10x10 = torch.cat((RGB_features_10x10*0.5, LW_features_10x10), dim=1)
        FUSION_features_10x10 = self.conv10(FUSION_features_10x10)
        FUSION_features_19x19 = torch.cat((RGB_features_19x19*0.5, LW_features_19x19), dim=1)
        ...
        FUSION_features_5x5 = torch.cat((RGB_features_5x5*0.5, LW_features_5x5), dim=1)
        FUSION_features_5x5 = self.conv5(FUSION_features_5x5)
        FUSION_features_3x3 = torch.cat((RGB_features_3x3*0.5, LW_features_3x3), dim=1)
        FUSION_features_3x3 = self.conv3(FUSION_features_3x3)
        FUSION_features_2x2 = torch.cat((RGB_features_2x2*0.5, LW_features_2x2), dim=1)
        FUSION_features_2x2 = self.conv2(FUSION_features_2x2)
        FUSION_features_1x1 = torch.cat((RGB_features_1x1*0.5, LW_features_1x1), dim=1)
        ...
        # FUSION_features_19x19=FUSION_features_19x19+RGB_features_19x19+LW_features_19x19
        # FUSION_features_10x10=FUSION_features_10x10+RGB_features_10x10+LW_features_10x10
        # FUSION_features_5x5=FUSION_features_5x5+RGB_features_5x5+LW_features_5x5
        # FUSION_features_3x3=FUSION_features_3x3+RGB_features_3x3+LW_features_3x3
        # FUSION_features_2x2=FUSION_features_2x2+RGB_features_2x2+LW_features_2x2
        # FUSION_features_1x1=FUSION_features_1x1+RGB_features_1x1+LW_features_1x1
        ...
        FUSION_locs, FUSION_class_scores = self.FUSION_prediction_network.forward(FUSION_features_19x19,
                                                                                  ...
                                                                                  FUSION_features_2x2,
                                                                                  FUSION_features_1x1)
        RGB_class_scores = self.RGB_prediction_network.forward(RGB_features_19x19,
                                                                                  RGB_features_10x10,
                                                                                  RGB_features_5x5,
                                                                                  RGB_features_3x3,
                                                                                  RGB_features_2x2,
                                                                                  RGB_features_1x1)
        LW_class_scores = self.LW_prediction_network.forward(LW_features_19x19,
                                                               LW_features_10x10,
                                                               LW_features_5x5,
                                                               LW_features_3x3,
                                                               LW_features_2x2,
                                                               LW_features_1x1)
        FUSION_class_scores = FUSION_class_scores+ LW_class_scores+RGB_class_scores

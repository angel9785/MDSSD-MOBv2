...
from utils import *
from first_model import SSD_FUSION
import argparse
import math
import warnings
...
def main():
    ...
    # Learning parameters
    # checkpoint = 'BEST_fine_checkpoint_ssd300_fusion1.pth.tar'#None  # path to model checkpoint, None if none
    # checkpoint = None
    # checkpoint = torch.load('BEST_fine_checkpoint_ssd300_fusion1.pth.tar')

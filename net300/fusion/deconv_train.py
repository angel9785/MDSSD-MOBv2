...
from deconv_fusion_v2 import SSD_FUSION
import argparse
import math
import warnings
...
checkpoint_rgb = torch.load('/home/fereshteh/codergb_new/BEST_dec_mob2_fine_checkpoint_ssd300_rgb5.pth.tar')
...
checkpoint_lw = torch.load('/home/fereshteh/codelw_new/BEST_dec_mob2_fine_checkpoint_ssd3300_lw4.pth.tar')
...
def main():
    ...
    # checkpoint = None
    checkpoint = torch.load('./BEST_new_mob2_NEW_fine_checkpoint_ssd300_fusion9.pth.tar')

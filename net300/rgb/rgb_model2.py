...
import torch
import math
from mobilenet_ssd_priors2 import *
...
class RGB_DeConvolutions(nn.Module):
    ...
    def forward(self, RGB_features_19x19, RGB_features_10x10, RGB_features_5x5, RGB_features_3x3):#, RGB_features_2x2, RGB_features_1x1
...
class SSD_RGB(nn.Module):
    ...
    def forward(self, RGB_image):
        ...
        layer_output = x
        RGB_features_5x5, RGB_features_3x3 = self.RGB_aux_network(layer_output) #, RGB_features_2x2, RGB_features_1x1
        RGB_refine_19x19, RGB_refine_10x10,RGB_refine_5x5, RGB_refine_3x3=self.RGB_DeConvolutions(RGB_features_19x19, RGB_features_10x10,RGB_features_5x5, RGB_features_3x3)
        ...
        RGB_locs, RGB_class_scores = self.RGB_prediction_network.forward(RGB_refine_19x19, RGB_refine_10x10,RGB_refine_5x5, RGB_refine_3x3)

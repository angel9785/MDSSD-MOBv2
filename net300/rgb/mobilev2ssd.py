...
class SSD(nn.Module):
    ...
    def forward(self, image):
        ...
        features = []
        features.append(features_19x19) #torch.Size([1, 512, 19, 19])
        features.append(features_10x10) #torch.Size([1, 1024, 10, 10])
        features.append(features_5x5) #torch.Size([1, 512, 5, 5])
        features.append(features_3x3) #torch.Size([1, 256, 3, 3])
        features.append(features_2x2) #torch.Size([1, 256, 2, 2])
        features.append(features_1x1) #torch.Size([1, 256, 1, 1])
        ...
        return locs, class_scores #torch.Size([2268, 4]) & torch.Size([2268, 2])
'''
import numpy as np
import torch

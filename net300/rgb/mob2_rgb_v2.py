...
class SSD_RGB(nn.Module):
    ...
    def forward(self, RGB_image):
        ...
        RGB_locs, RGB_class_scores = self.RGB_prediction_network.forward(RGB_features_38x38,RGB_features_19x19, RGB_features_10x10,
                                                                         RGB_features_5x5, RGB_features_3x3,

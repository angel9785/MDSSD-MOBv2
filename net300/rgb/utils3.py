...
def create_data_lists(kaist_path, output_folder):
    ...
    # # for path in sani:
    sanitest = '/home/fereshteh/kaist/eval_rgb'
...
def transform(image, boxes, labels, difficulties, split):
    ...
    """
    assert split in {'TRAIN', 'TEST', 'DAY', 'SANITEST', 'ALLSANITEST', 'SANITRAIN', 'SANITRAIN1', 'ALLSANIVAL1'}
    ...
    if (split == 'TRAIN' or split == 'SANITRAIN' or split == 'SANITRAIN1'):
...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, best_loss, is_best):
    ...
    filename = 's_dec_fine_checkpoint_ssd300.pth.tar'

...
def main():
    ...
    # checkpoint = None
    # checkpoint = torch.load('./BEST_dec_fine_checkpoint_ssd300_lw.pth.tar')
    ...
    model = SSD_LW(num_classes=n_classes, backbone_network=backbone_network)
    # global model

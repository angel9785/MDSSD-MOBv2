...
class LW_PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv5_feats, conv11_feats, conv13_feats, conv14_2_feats, conv15_2_feats, conv16_2_feats,
                conv17_2_feats):
        ...
        locs = torch.cat([l_conv5, l_conv11, l_conv13, l_conv14_2, l_conv15_2, l_conv16_2, l_conv17_2],
                         dim=1)  # (N, 2268, 4)
...
class SSD_LW(nn.Module):
    ...
    def forward(self, LW_image):
        ...
        LW_locs, LW_class_scores = self.LW_prediction_network.forward(LW_features_38x38, LW_features_19x19,
                                                                         LW_features_10x10,
...
img_path = '/home/fereshteh/codelw/I02658.png'

...
class SSD_LW(nn.Module):
    ...
    def forward(self, LW_image):
        ...
        layer_output = x
        LW_features_5x5, LW_features_3x3, LW_features_2x2, LW_features_1x1 = self.LW_aux_network(layer_output)
        # LW_refine_19x19, LW_refine_10x10,LW_refine_5x5, LW_refine_3x3, LW_refine_2x2, LW_refine_1x1=self.LW_DeConvolutions(LW_features_19x19, LW_features_10x10,LW_features_5x5, LW_features_3x3,LW_features_2x2,LW_features_1x1)

        # features = []
        # features.append(LW_features_38x38)
        ...
        LW_locs, LW_class_scores = self.LW_prediction_network.forward(LW_features_19x19, LW_features_10x10,
                                                                         LW_features_5x5, LW_features_3x3,

...
import torch
import math
from mobilenet_ssd_priors1 import *
...
class LW_AuxillaryConvolutions(nn.Module):
    ...
    def forward(self, LW_inp_features_10x10):
        LW_features = []
        x = LW_inp_features_10x10
        for layer in self.extras:
            x = layer(x)
            LW_features.append(x)

        LW_features_5x5 = LW_features[0]
        LW_features_3x3 = LW_features[1]
        # LW_features_2x2 = LW_features[2]
        # LW_features_1x1 = LW_features[3]
        return LW_features_5x5, LW_features_3x3 #, LW_features_2x2, LW_features_1x1
...
class LW_DeConvolutions(nn.Module):
    ...
    def forward(self, LW_features_19x19, LW_features_10x10, LW_features_5x5,
        ...
        LW_refine1_10x10 = self.refine10(LW_features_10x10)
        x10 = LW_refine1_10x10 + LW_dconv_5x5 + LW_features_10x10
        LW_refine_10x10 = self.late10(x10)
        LW_dconv_10x10 = self.dconv10(LW_features_10x10)
        LW_refine1_19x19 = self.refine19(LW_features_19x19)
        x19 = LW_refine1_19x19 + LW_dconv_10x10 + LW_features_19x19
        LW_refine_19x19 = self.late19(x19)

        # LW_features_2x2 = LW_features[2]
        # LW_features_1x1 = LW_features[3]
        return LW_refine_19x19, LW_refine_10x10, LW_refine_5x5, LW_refine_3x3# , LW_features_2x2, LW_features_1x1 # , LW_refine_2x2, LW_refine_1x1
    ...
    def forward(self, LW_image):
        ...
        if self.backbone_net == 'MobileNetV1':
            ...
            for end_layer_index in source_layer_indexes:
                ...
                if flag == 0:
                    LW_features_19x19 = layer_output
                elif flag == 1:
                    LW_features_10x10 = layer_output
                flag += 1
        ...
        layer_output = x
        LW_features_5x5, LW_features_3x3= self.LW_aux_network(layer_output)  # , LW_features_2x2, LW_features_1x1
        LW_refine_19x19, LW_refine_10x10, LW_refine_5x5, LW_refine_3x3 = self.LW_DeConvolutions(LW_features_19x19,
                                                                                                     LW_features_10x10,
                                                                                                     LW_features_5x5,
                                                                                                     LW_features_3x3)
        # , LW_refine_2x2, LW_refine_1x1  ,LW_features_2x2,LW_features_1x1
        # target_mean19 = torch.mean(LW_refine_19x19)
        # target_std19 = torch.std(LW_refine_19x19)
        # LW_refine_19x19 = LW_refine_19x19 - target_mean19
        # LW_refine_19x19 = LW_refine_19x19 / target_std19
        #
        # target_mean10 = torch.mean(LW_refine_10x10)
        # target_std10 = torch.std(LW_refine_10x10)
        # LW_refine_10x10 = LW_refine_10x10 - target_mean10
        # LW_refine_10x10 = LW_refine_10x10 / target_std10
        #
        ...
        # FUSION_features_10x10 = torch.cat((LW_features_10x10, LW_refine_10x10), dim=1)
        # features_10x10 = self.conv10(FUSION_features_10x10)
        # FUSION_features_19x19 = torch.cat((LW_features_19x19, LW_refine_19x19), dim=1)
        ...
        # # layer_output = LW_features_10x10
        ...
        # features = []
        # features.append(LW_features_19x19)  # torch.Size([1, 512, 19, 19])
        # features.append(LW_features_10x10)  # torch.Size([1, 1024, 10, 10])
        ...
        # features_19x19 = LW_features_19x19 + LW_refine_19x19
        # features_10x10 = LW_features_10x10 + LW_refine_10x10
        ...
        # LW_locs, LW_class_scores = self.LW_prediction_network.forward(LW_features_19x19, LW_features_10x10, LW_features_5x5, LW_features_3x3,
        #                                                      LW_features_2x2, LW_features_1x1)
        LW_locs, LW_class_scores = self.LW_prediction_network.forward(LW_refine_19x19, LW_refine_10x10,
                                                                         LW_refine_5x5, LW_refine_3x3)
        # , LW_refine_2x2, LW_refine_1x1

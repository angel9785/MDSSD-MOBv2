...
class RGB_DeConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        def dconv(inp, oup, p, po):
            return nn.ConvTranspose2d(inp, oup, kernel_size=2, stride=2, padding=p, output_padding=po)
        ...
        self.dconv3 = dconv(256, 512, 1, 1)
        self.dconv5 = dconv(512, 1280, 0, 0)
        self.dconv10 = dconv(1280, 96, 1, 1)

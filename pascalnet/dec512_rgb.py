...
import torch
import math
from mobilenet_ssd_priors_512 import *
...
class RGB_PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv11_feats, conv13_feats, conv14_2_feats, conv15_2_feats, conv16_2_feats, conv17_2_feats):  # , conv16_2_feats, conv17_2_feats
        ...
        locs = torch.cat([l_conv11, l_conv13, l_conv14_2, l_conv15_2, l_conv16_2, l_conv17_2], dim=1)  # (N, 2268, 4)  , l_conv16_2, l_conv17_2
...
class RGB_DeConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        def dconv(inp, oup):
            return nn.ConvTranspose2d(inp, oup, kernel_size=3, stride=2, padding=1, output_padding=1)

        # self.refine1 = conv_3(256)
        # self.refine2 = conv_3(256)
        # self.refine3 = conv_3(256)
        self.refine5 = conv_3(512)
        self.refine10 = conv_3(1280)
        self.refine19 = conv_3(96)

        # self.dconv1 = dconv(256, 256, 0, 0)
        # self.dconv2 = dconv(256, 256, 1, 1)
        self.dconv3 = dconv(256, 512)
        self.dconv5 = dconv(512, 1280)
        self.dconv10 = dconv(1280, 96)
        # self.late1 = late_conv_3(256)
        # self.late2 = late_conv_3(256)
        self.late3 = late_conv_3(256)
        self.late5 = late_conv_3(512)
        self.late10 = late_conv_3(1280)
        self.late19 = late_conv_3(96)
        self.init_conv2d()
    ...
    def forward(self, RGB_features_19x19, RGB_features_10x10, RGB_features_5x5,
                RGB_features_3x3, RGB_features_2x2, RGB_features_1x1):  # , RGB_features_2x2, RGB_features_1x1

        # RGB_refine1_1x1 = self.refine1(RGB_features_1x1)
        # RGB_refine_1x1 = self.late1(RGB_refine1_1x1)
        # RGB_refine_1x1=RGB_features_1x1
        # RGB_dconv_1x1 = self.dconv1(RGB_refine_1x1)
        # RGB_refine1_2x2 = self.refine2(RGB_features_2x2)
        # x2=RGB_refine1_2x2 + RGB_dconv_1x1+RGB_features_2x2
        # RGB_refine_2x2 = self.late2(x2)
        # RGB_dconv_2x2 = self.dconv2(RGB_refine_2x2)
        # RGB_refine1_3x3= self.refine3(RGB_features_3x3)
        # x3=RGB_refine1_3x3+RGB_dconv_2x2+RGB_features_3x3
        # RGB_refine_3x3 = self.late3(x3)
        ...
        RGB_refine1_10x10 = self.refine10(RGB_features_10x10)
        x10 = RGB_refine1_10x10 + RGB_dconv_5x5 + RGB_features_10x10
        RGB_refine_10x10 = self.late10(x10)
        RGB_dconv_10x10 = self.dconv10(RGB_features_10x10)
        RGB_refine1_19x19 = self.refine19(RGB_features_19x19)
        x19 = RGB_refine1_19x19 + RGB_dconv_10x10 + RGB_features_19x19
        RGB_refine_19x19 = self.late19(x19)

        RGB_refine_2x2=RGB_features_2x2
        RGB_refine_1x1=RGB_features_1x1
        return RGB_refine_19x19, RGB_refine_10x10, RGB_refine_5x5, RGB_refine_3x3 , RGB_refine_2x2, RGB_refine_1x1
...
class SSD_RGB(nn.Module):
    ...
    def forward(self, RGB_image):
        ...
        layer_output = x
        RGB_features_5x5, RGB_features_3x3, RGB_features_2x2, RGB_features_1x1 = self.RGB_aux_network(layer_output)  # , RGB_features_2x2, RGB_features_1x1
        RGB_refine_19x19, RGB_refine_10x10, RGB_refine_5x5, RGB_refine_3x3,RGB_refine_2x2, RGB_refine_1x1 = self.RGB_DeConvolutions(RGB_features_19x19,
                                                                                                     RGB_features_10x10,
                                                                                                     RGB_features_5x5,
                                                                                                     RGB_features_3x3,RGB_features_2x2, RGB_features_1x1)
        # , RGB_refine_2x2, RGB_refine_1x1  ,RGB_features_2x2,RGB_features_1x1
        # target_mean19 = torch.mean(RGB_refine_19x19)
        # target_std19 = torch.std(RGB_refine_19x19)
        # RGB_refine_19x19 = RGB_refine_19x19 - target_mean19
        # RGB_refine_19x19 = RGB_refine_19x19 / target_std19
        #
        # target_mean10 = torch.mean(RGB_refine_10x10)
        # target_std10 = torch.std(RGB_refine_10x10)
        # RGB_refine_10x10 = RGB_refine_10x10 - target_mean10
        # RGB_refine_10x10 = RGB_refine_10x10 / target_std10
        #
        # target_mean5 = torch.mean(RGB_refine_5x5)
        # target_std5 = torch.std(RGB_refine_5x5)
        # RGB_refine_5x5 = RGB_refine_5x5 - target_mean5
        # RGB_refine_5x5 = RGB_refine_5x5 / target_std5
        #
        # target_mean3 = torch.mean(RGB_refine_3x3)
        # target_std3 = torch.std(RGB_refine_3x3)
        # RGB_refine_3x3 = RGB_refine_3x3 - target_mean3
        # RGB_refine_3x3 = RGB_refine_3x3 / target_std3
        #
        # target_mean1 = torch.mean(RGB_refine_1x1)
        # target_std1 = torch.std(RGB_refine_1x1)
        # RGB_refine_1x1 = RGB_refine_1x1 - target_mean1
        # RGB_refine_1x1 = RGB_refine_1x1 / target_std1
        #
        # target_mean2 = torch.mean(RGB_refine_2x2)
        # target_std2 = torch.std(RGB_refine_2x2)
        # RGB_refine_2x2 = RGB_refine_2x2 - target_mean2
        # RGB_refine_2x2 = RGB_refine_2x2 / target_std2

        # FUSION_features_10x10 = torch.cat((RGB_features_10x10, RGB_refine_10x10), dim=1)
        # features_10x10 = self.conv10(FUSION_features_10x10)
        # FUSION_features_19x19 = torch.cat((RGB_features_19x19, RGB_refine_19x19), dim=1)
        # # return FUSION_features_10x10.size(1), FUSION_features_19x19.size(1)
        # # conv19 = nn.Conv2d(1024, 512, 1, 1, 0, bias=False)
        # features_19x19 = self.conv19(FUSION_features_19x19)
        ...
        # # RGB_features_5x5, RGB_features_3x3, RGB_features_2x2, RGB_features_1x1 = self.rgb_aux_network.forward(
        # #     layer_output)
        # # LW_features_5x5, LW_features_3x3, LW_features_2x2, LW_features_1x1 = self.lw_aux_network.forward(layer_output1)
        #
        # FUSION_features_5x5 = torch.cat((RGB_features_5x5, RGB_refine_5x5), dim=1)
        # features_5x5 = self.conv5(FUSION_features_5x5)
        # FUSION_features_3x3 = torch.cat((RGB_features_3x3, RGB_refine_3x3), dim=1)
        # features_3x3 = self.conv3(FUSION_features_3x3)
        # FUSION_features_2x2 = torch.cat((RGB_features_2x2, RGB_refine_2x2), dim=1)
        # features_2x2 = self.conv2(FUSION_features_2x2)
        # FUSION_features_1x1 = torch.cat((RGB_features_1x1, RGB_refine_1x1), dim=1)
        ...
        # features_19x19 = RGB_features_19x19 + RGB_refine_19x19
        # features_10x10 = RGB_features_10x10 + RGB_refine_10x10
        # features_5x5 = RGB_features_5x5 + RGB_refine_5x5
        # features_3x3 = RGB_features_3x3 + RGB_refine_3x3
        # features_2x2 = RGB_features_2x2 + RGB_refine_2x2
        # features_1x1 = RGB_features_1x1 + RGB_refine_1x1
        # RGB_locs, RGB_class_scores = self.RGB_prediction_network.forward(RGB_features_19x19, RGB_features_10x10, RGB_features_5x5, RGB_features_3x3,
        #                                                      RGB_features_2x2, RGB_features_1x1)
        RGB_locs, RGB_class_scores = self.RGB_prediction_network.forward(RGB_refine_19x19, RGB_refine_10x10,
                                                                         RGB_refine_5x5, RGB_refine_3x3,RGB_refine_2x2, RGB_refine_1x1)
        # , RGB_refine_2x2, RGB_refine_1x1

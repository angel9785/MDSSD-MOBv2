...
# 	   "refrigerator","book","clock","vase","scissors","teddy bear","hair drier","toothbrush","background")
...
def main():
    ...
    # Learning parameters
    # checkpoint = torch.load('BEST_300pascalvoc_dec_checkpoint_ssd_new_BN.pth.tar')  # path to model checkpoint, None if none
    batch_size = 32 # batch size
    # start_epoch = checkpoint['epoch']  # start at this epoch
    start_epoch =0
    ...
    # create_data_lists1(output_folder=config['data_folder'])

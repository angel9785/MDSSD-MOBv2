...
def main():
    ...
    checkpoint = torch.load('513pascalvoc_dec_checkpoint_ssd_new10.pth.tar')  # path to model checkpoint, None if none
    batch_size =12  # batch size
    start_epoch =0
    # start_epoch = checkpoint['epoch'] +1 # start at this epoch
    # epochs = 80  # number of epochs to run without early-stopping

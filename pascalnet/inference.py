...
def detect(model, original_image, min_score, max_overlap, top_k, suppress=['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable',
...
img_path = '/home/fereshteh/code/SSD_MobileNet-master/dataset/VOCtest_06-Nov-2007/VOCdevkit/VOC2007/JPEGImages/000182.jpg'
img_path ="/home/fereshteh/code/SSD_MobileNet-master/1.jpg"
checkpoint = torch.load('./voc_checkpoint_ssd3001_2.pth.tar')
print(checkpoint["epoch"])
# checkpoint = torch.load('BEST_voc_checkpoint_ssd300.pth.tar')
...
backbone_network='MobileNetV1'
def main(img_path,checkpoint):
	
    #img_path = args.img_path
    
    #img_path = '/home/fereshteh/code/SSD_MobileNet-master/img_path/000001.jpg'
    ...
    detect(model, original_image, min_score=0.26, max_overlap=0.5, top_k=200).show()
